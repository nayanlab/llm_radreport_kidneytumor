...
df['solidmasscomplexcyst_re'] = df['narrative_imp_combined'].apply(solidmasscomplexcyst)

# RE-Assisted - Two Staged Approach
# Completed on impression_fillednarative, a targetted text most likely to have relevant data pointing to mass of interest
df['solidmasscomplexcyst_re_fs'] = df['impression_fillednarrative'].apply(solidmasscomplexcyst)


# Output file
df.to_excel('output_solidmass_complexcyst{today_date}.xlsx', index=False)